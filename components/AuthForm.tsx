        ...
        <>
          <Form {...form}>
            ...
            {type === 'sign-up' && (
              ...
              <CustomInput control={form.control} name={'email'} label='Email' placeholder='Enter the email' />
              <CustomInput control={form.control} name={'password'} label='Password' placeholder='Enter the password' />
              <div className='flex flex-col gap-4'>
